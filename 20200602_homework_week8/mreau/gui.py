...
#misc.imshow(toImg(net.encode(loadImg('a.png'))[0]-net.encode(loadImg('b.png'))[0] + net.encode(loadImg('f.png'))[0]))
#misc.imshow(torch.cat([toImg(net.encode(loadImg('a.png'))[0]*(i/10.) + net.encode(loadImg('f.png'))[0]*(1-(i/10.))) for i in range(11)],1))
